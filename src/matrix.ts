...
export default class Matrix {
  // BP levels only. The FRAG code paths were dropped in this fork, so a
  // matrix's FRAG zoom levels are parsed off the wire and discarded rather than
  // kept in a second list nothing can reach.
