...
import type MatrixZoomData from '../src/matrixZoomData.ts'
...
class BlockWriter {
  ...
  deflated(): ArrayBuffer {
    const out = deflate(new Uint8Array(this.bytes), {}) as Uint8Array
...
async function readBlock(version: number, w: BlockWriter) {
  ...
  const file = new HicFile({
    reader: { read: () => Promise.resolve(data) },
  })
